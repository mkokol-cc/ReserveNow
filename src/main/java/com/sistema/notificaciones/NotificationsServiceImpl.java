...
public class NotificationsServiceImpl implements NotificationsService {
	...
	@Override
	public void enviarWppValidacionUsuario(String telefono, String codigo) throws Exception {
		String mensaje = "Codigo de Validación: "+codigo+".";
		enviarWhatsApp(telefono,mensaje);
		
	}
	@Override
	public void notificarWppCambioEstadoReserva(Reserva r) throws Exception {
		String mensaje = "Tu reserva con "+
				r.getReservante().getUsuario().getUsername()+
				". Detalles: "+
				r.getAsignacionTipoTurno().getTipoTurno().getNombre()+
				" - "+
				r.getAsignacionTipoTurno().getRecurso().getNombre()+
				" El dia "+
				r.getFechaHoraInicio().toLocalDate()+
				" a las "+
				r.getFechaHoraInicio().toLocalTime()+
				", ahora esta "+
				r.getEstado().getNombre();
		enviarWhatsApp(r.getReservante().getTelefono(),mensaje);
	}
	...
	*/
	...
	@Override
	public void notificarWppProximaReserva(Reserva r) throws Exception {
		String mensaje = "Recuerda que tienes una reserva con "+
				r.getReservante().getUsuario().getUsername()+
				". Detalles: "+
				r.getAsignacionTipoTurno().getTipoTurno().getNombre()+
				" - "+
	...
	@Override
	public void enviarEmailBienvenida(Usuario u) throws Exception {
		String header = generarHeader("Gracias por unirte");
		String cuerpo = "Hace click para activar tu cuenta."+
				generarBotonLink(dominio+"/verify-email/"+generarToken(u),"Click Aquí");
		String footer = generarFooter();
		enviarEmail(u.getEmail(),header+cuerpo+footer,"¡Bienvenido!");
	}
